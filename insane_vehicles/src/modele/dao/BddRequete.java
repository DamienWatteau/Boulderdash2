...
public class BddRequete {
	...
	public void selectTable(String level) {
		...
		try {
			...
			Statement st; // L'objet Statement permet d'exécuter des
							// instructions SQL (Il interroge la base de donnée
							// et retourne les résultats)
			ResultSet rst; // L'objet ResultSet stocke les résultats de
							// Statement (soit les données de la BDD)
